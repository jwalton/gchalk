...
func TestScreenshot(t *testing.T) {
	...
	fmt.Println()
	fmt.Println(`fmt.Println(gawk.CyanBrightAnd().BgBlue("Cyan text with a blue background"))`)
	fmt.Println("// " + gawk.WithBgBlue().CyanBright("Cyan text with a blue background"))
	fmt.Println()
